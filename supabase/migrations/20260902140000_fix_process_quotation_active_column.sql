-- Correct the process-applicability column used by quotation normalization.
-- Active zero-quantity processes remain quoteable; inactive processes remain rejected.
