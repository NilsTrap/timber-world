...
const mode = (book: "clients" | "suppliers", grant: boolean, own: Record<string, boolean> | null, admin = false) =>
...
ok("traders book remains admin-only", decideCounterpartyBookMode({ book: "traders", platformAdmin: false, hasExactBookGrant: true, callerOrgId: ORG, callerOrg: { is_trader: true } }) === null);
