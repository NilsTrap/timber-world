...
export function CounterpartyProfile({ book, profile }: { book: CounterpartyBook; profile: Profile }) {
  ...
  return <div className="space-y-6">
    ...
    {profile.canOnboardPeople && <Card><CardHeader><CardTitle>Portal people</CardTitle></CardHeader><CardContent><CrmOrgUsersSection organisationId={profile.id} /></CardContent></Card>}
  </div>;
}
