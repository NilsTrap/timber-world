...
import { Button, Popover, PopoverContent, PopoverTrigger } from "@timber/ui";
...
interface ColumnHeaderMenuProps {
  ...
  isNumeric?: boolean;
  /** Unique display values for filter checkboxes */
  uniqueValues: string[];
  /** Currently active sort (null if none or different column) */
  activeSort: ColumnSortState | null;
  /** Currently active filter set (empty = no filter) */
