...
ok("read-only specification tables expose no checkbox controls", specificationTables.includes('canEdit ? <label') && specificationTables.includes('canEdit ? <td className="px-2 py-1"'));
