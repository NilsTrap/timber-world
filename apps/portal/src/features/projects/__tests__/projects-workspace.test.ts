...
ok("process snapshots are visible to both project parties", processFieldsMigration.includes("current_user_in_org(deal.buyer_organisation_id)") && processFieldsMigration.includes("current_user_in_org(deal.seller_organisation_id)"));
