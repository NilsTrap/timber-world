...
ok("read-only specification tables expose no editable controls", specificationTables.includes("fieldEditable ? <input") && specificationTables.includes("editableSnapshot ? <input") && specificationTables.includes('canEdit ? <div className="ml-auto'));
