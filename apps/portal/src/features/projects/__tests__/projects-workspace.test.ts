...
ok("direct project parties use the full project view before RFQ candidate projection", projectLoader.indexOf("const actorIsDirectParty") < projectLoader.indexOf("loadRfqCandidateProject(a.db") && projectLoader.includes("!a.isPlatformAdmin && !actorIsDirectParty"));
