...
const html = cleanHtmlText('<html><head><style>@/**/import "https://attacker.test/tracker.css";@import"https://attacker.test/no-space.css";@\\69mport "https://attacker.test/escaped.css";.report{display:grid;color:green;background:url(data:image/png;base64,AA==)}.buyer-ltd{font-weight:bold}.BuyerLtd{color:red}.leak{background:u\\72l(https://attacker.test/pixel)}.set{background:image-set("https://attacker.test/two.png" 2x)}.break{content:"\\3C /style>\\3C script>alert(1)\\3C /script>"}.invalid{content:"\\110000"}</style><script>alert(1)</script><meta name="owner" content="Buyer Ltd"><base href="https://attacker.test"></head><body/onload=steal()><form action=javascript:steal()><h1 class="report buyer\\2d ltd" style="background:u\\72l(https://attacker.test/inline)">Buyer Ltd</h1><img src="https://attacker.test/pixel.png" srcset="https://attacker.test/2x.png 2x"><p>jane&#64;buyer.test</p><a href="java&#x73;cript:steal()">unsafe</a><svg><a xlink:href="javascript:steal()">svg</a></svg><iframe srcdoc="unsafe"></iframe></form></body></html>', terms);
