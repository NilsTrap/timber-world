...
/** T2 · WRITE capabilities for this domain — org card + access-group writes are all
 *  owner/admin-only (RLS admin-walled; the "admin" capability mirrors the portal gate). */
 ...
 * for that tool (arg validation + service call), unchanged.
 */
