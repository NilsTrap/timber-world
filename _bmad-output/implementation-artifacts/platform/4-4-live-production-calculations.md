...
- [Source: _bmad-output/planning-artifacts/platform/epics.md#Story 4.4]
...
- [Source: _bmad-output/implementation-artifacts/platform/4-3-add-production-outputs.md — previous story learnings]
