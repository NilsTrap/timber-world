...
- [Source: _bmad-output/planning-artifacts/platform/epics.md#Story 3.2]
- [Source: _bmad-output/implementation-artifacts/platform/3-1-producer-inventory-table.md]
